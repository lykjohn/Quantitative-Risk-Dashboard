                                        ...
                                        bsCollapsePanel("GARCH Summary Table",
                                                        bsCollapsePanel("Diagnostics:", tags$div(
                                                          tags$ul(
                                                            ...
                                                            tags$li(HTML("<p><strong> AIC & BIC: </strong> We desire the model with the least AIC and BIC values. Compare these criteria for all models fitted, and select the model with the least value before it starts increasing. AIC tends to choose models with larger number of parameters while BIC tends to chose models with smaller number of parameters.</p>"))    
                                                          )
                                                        ), 
                                                        style = "primary"),             
                                          fluidRow(
